...
<table border="1">
	<tr height="80" bgcolor="lightblue" align="center">
	    <td  width="350"><p align="left"/>
	       <a href="<c:url value='/ch04/ex00/registerMember.jsp' />">新增會員資料(Hibernate)</a><br>
	       <font face="verdana" size="-2">webapp/ch04/ex00/registerMember.jsp
	      <br>webapp/ch04/ex00/*.jsp<br>ch04.ex00.....*.java</font>
	    </td>
	    <td  width="350"><p align="left">
	      <a href="<c:url value='/ch04/ex00/queryAllMembers.do' />">查詢會員資料(Hibernate)</a><br>
	      <font face="verdana" size="-2">webapp/ch04/ex00/showAllMembers.jsp<br>
	      ch04.ex00.controller.*.java<br>ch04.ex00....*.java</font>
	    </td>
	</tr>
