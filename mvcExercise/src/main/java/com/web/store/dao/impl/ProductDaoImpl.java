...
public class ProductDaoImpl implements ProductDao {
	...
	public List<BookBean> getAllProducts() {
		...
		list = session.createQuery(hql, BookBean.class).getResultList();
		return list;
	}
	...
	public void updateStock(int productId, int newQuantity) {
		...
		String hql = "UPDATE BookBean b SET b.stock = :stk WHERE bookId = :bid";
		session.createQuery(hql).setParameter("stk", newQuantity).setParameter("bid", productId).executeUpdate();
	...
	public List<BookBean> getProductsByCategory(String category) {
		...
		List<BookBean> list = session.createQuery(hql, BookBean.class).setParameter("category", category)
				.getResultList();
		return list;
	}
