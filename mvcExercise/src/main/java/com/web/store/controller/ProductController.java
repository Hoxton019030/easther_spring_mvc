...
//									"bookxb002.jpg", "P832", null, 25,	"Web", cb);//記得要把外來鍵給到
//		model.addAttribute("product", bb);
//		return "products";//視圖邏輯名稱
//		
//	}
	...
	@GetMapping("/products/add") // 送出空白表單
	public String getAddNewProductForm(Model model) {
		BookBean bb = new BookBean();
		bb.setTitle("Spring總是學不會");
		bb.setAuthor("王春春");
		model.addAttribute("bookBean", bb);
		return "addProduct";
	}

//	@PostMapping("/products/add") //真正的新增表單新增一定要用post
...
//	}
	...
	public String processAddNewProductForm(@ModelAttribute("bookBean") BookBean bb, BindingResult result) {
		...
		return "redirect:/products";// 新增成功一定要用redirect:(會對網址重新提出請求)
	}
...
//	}
	...
	//改成用 Spring MVC model物件
	@ExceptionHandler(ProductNotFoundException.class)
	public  String  handleError  (HttpServletRequest request, ProductNotFoundException exception ,  Model model) {
		{
