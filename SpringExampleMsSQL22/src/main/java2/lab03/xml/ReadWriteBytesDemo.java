...
public class ReadWriteBytesDemo {
	public static void main(String[] args) throws IOException {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("lab03\\xml\\Beans.xml");
...
//			InputStream is = ctx.getBean(InputStream.class);
				InputStream fis = (InputStream) ctx.getBean("fis");

				OutputStream fos = (OutputStream) ctx.getBean("fos");) {
