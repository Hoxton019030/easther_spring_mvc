...
//   	
	@Before(
//			"execution (* ch04._02.aspectj.interfaces.ArithmeticCalculator.*(..)) "//另一種寫法
			 " execution (* ch04._02.aspectj.interfaces.ArithmeticCalculator.mul(int, int)) "
		  + " || execution (* ch04._02.aspectj.interfaces.ArithmeticCalculator.add(int, int)) "
//		  + " || execution (* ch04._02.aspectj.interfaces.ArithmeticCalculator.hello(..)) "
			)
