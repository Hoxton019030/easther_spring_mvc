...
public class MainClassAfterReturningAdvice {

	public static void main(String[] args) {
		ApplicationContext ctx = 
			new ClassPathXmlApplicationContext("ch04/_02/aspectj/aspect/_03/applicationContext.xml");
		...
		arithmeticCalculator.noRV();
		System.out.println("=====> MainClass送出的訊息, noRV");
