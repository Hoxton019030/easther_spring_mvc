...
public class MainClassBeforeAdvice {

	public static void main(String[] args) {
		ApplicationContext ctx = 
			new ClassPathXmlApplicationContext("ch04/_02/aspectj/aspect/_01/applicationContext.xml");
		...
		try {
			int div = arithmeticCalculator.div(80, 10);
